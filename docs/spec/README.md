...
| 2 | [`02-specification.md`](02-specification.md) | Especificación | Índice maestro de las HU (detalle en `../user-stories.md`) |
| 3 | [`03-plan.md`](03-plan.md) | **Diseño** | Stack, capas, contrato de API, decisiones técnicas |
| 4 | [`04-tasks.md`](04-tasks.md) | Plan de trabajo | Descomposición en 102 tareas ordenadas y trazables |
...
- `../user-stories.md` — las 17 HU con sus escenarios BDD/Gherkin (fuente canónica del spec).
